...
def calculates_results_stats(results_dic):
    ...
    """        
    # print('#'*5 + 'STARTING CALCULATE_RESULTS.PY' + '#'*5)
    ...
    #print("number of matches: {}, Number of images: {}, percentage match: {}".format(results_stats_dic['n_match'], results_stats_dic['n_images'], results_stats_dic['pct_match'])
    ...
    if results_stats_dic['n_notdogs_img'] > 0.0:
