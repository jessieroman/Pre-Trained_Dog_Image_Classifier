...
def classify_images(images_dir, results_dic, model):
    ...
    # print('#'*5 + 'STARTING CLASSIFY_IMAGES.PY' + '#'*5)
    for key in results_dic:
        ...
        #print("classify_images.py truth is set to: {}".format(truth))
        #print("classify_images.py model_label is set to: {}".format(model_label))
        ...
        # the extend function 
            ...
            # print("UGH... NOT A MATCH.")
            results_dic[key].append(model_label)
            results_dic[key].append(0)
            # print(results_dic[key])
        
    # print("results_dic after classify_images.py: {}".format(results_dic))
