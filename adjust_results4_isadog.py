...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    """           
    #print('#'*5 + 'STARTING ADJUST_RESULTS4_ISADOG.PY' + '#'*5)
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            line = line.strip()
            #print("line in adjust_results4_isdog.py is now set to: {}".format(line))
            ...
            line = infile.readline()
        # print("dognames_dic in adjust_results4_isdog.py is now set to: {}".format(dognames_dic))
    ...
    for key in results_dic:
        # print("key in adjust_results4_isdog.py is: {}".format(key))

        # Pet Image Label IS of Dog (e.g. found in dognames_dic)
        # print("Checking if {} is in dognames_dic (adjust_results4_isdog.py).".format(results_dic[key][0]))
        if results_dic[key][0] in dognames_dic:
            # print("pet label {} IS IN DOGNAMES_DIC (adjust_results4_isdog.py).".format(results_dic[key][0]))
            
            # Classifier Label IS image of Dog (e.g. found in dognames_dic)
            # appends (1, 1) because both labels are dogs
            
            # print('classifier label includes {}'.format(results_dic[key][1]))
            # print('classifier label type is: {}'.format(type(results_dic[key][1])))
            if results_dic[key][1] in dognames_dic:
                #print("classifier label {} IS IN DOGNAMES_DIC (adjust_results4_isdog.py).".format(results_dic[key][1]))
        ...
        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
            ...
            if results_dic[key][1] in dognames_dic:
                # print("UGH... pet label {} IS NOT IN DOGNAMES_DIC (adjust_results4_isdog.py).".format(results_dic[key][0]))
    ...
    # print('results_dic (adjust_results4_isdog): \n{}'.format(results_dic))